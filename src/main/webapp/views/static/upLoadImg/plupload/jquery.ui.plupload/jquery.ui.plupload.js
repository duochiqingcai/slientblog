 ...
 *
 * Depends:
 *	jquery.ui.core.upLoadImg
 *	jquery.ui.widget.upLoadImg
 *	jquery.ui.button.upLoadImg
 *	jquery.ui.progressbar.upLoadImg
 *	
 * Optionally:
 *	jquery.ui.sortable.upLoadImg
 */
...
@example
	...
	<script>
		$('#uploader').plupload({
			...
			rename: true,
			sortable: true,
			flash_swf_url : '../../upLoadImg/Moxie.swf',
			silverlight_xap_url : '../../upLoadImg/Moxie.xap',
		});
	</script>
