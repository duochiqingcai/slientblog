!function (e, t) {
    ...
    function r(e) {
        ...
        var o = t(e), i = o.overflow, f = o.overflowX, s = o.overflowY;
    ...
    function s(e, t) {
        ...
        if (e !== u && t !== u || r.contains(a)) return i(u) ? u : o(u);
        var d = f(e);
    ...
    function a(e) {
        ...
        if ("BODY" === r || "HTML" === r) {
            var o = window.document.documentElement, i = window.document.scrollingElement || o;
            return i[n]
        }
        return e[n]
    }
    ...
    function p(e, t) {
        var n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], r = a(t, "top"), o = a(t, "left"),
            i = n ? -1 : 1;
    ...
    function h(e) {
        ...
        var i = {left: n.left, top: n.top, width: n.right - n.left, height: n.bottom - n.top},
            f = "HTML" === e.nodeName ? l() : {}, s = f.width || e.clientWidth || i.right - i.left,
            p = f.height || e.clientHeight || i.bottom - i.top, d = e.offsetWidth - s, h = e.offsetHeight - p;
        if (d || h) {
            var m = t(e);
    ...
    function m(e, n) {
        var o = re(), i = "HTML" === n.nodeName, f = h(e), s = h(n), a = r(e), u = t(n),
            d = +u.borderTopWidth.split("px")[0], l = +u.borderLeftWidth.split("px")[0],
            m = c({top: f.top - s.top - d, left: f.left - s.left - l, width: f.width, height: f.height});
    ...
    function g(e) {
        var t = window.document.documentElement, n = m(e, t), r = V(t.clientWidth, window.innerWidth || 0),
            o = V(t.clientHeight, window.innerHeight || 0), i = a(t), f = a(t, "left"),
            s = {top: i - n.top + n.marginTop, left: f - n.left + n.marginLeft, width: r, height: o};
        return c(s)
    }
    ...
    function b(e, t, o, i) {
        ...
        if ("viewport" === i) f = g(a); else {
            ...
            var u = m(p, a);
            if ("HTML" !== p.nodeName || v(a)) f = u; else {
                var d = l(), c = d.height, h = d.width;
    ...
    function y(e, t, n, r, o) {
        ...
        }), u = 0 < p.length ? p[0].key : a[0].key, d = e.split("-")[1];
        return u + (d ? "-" + d : "")
    }
    ...
    function L(e, t, n) {
        n = n.split("-")[0];
        var r = E(e), o = {width: r.width, height: r.height}, i = -1 !== ["right", "left"].indexOf(n),
            f = i ? "top" : "left", s = i ? "left" : "top", a = i ? "height" : "width", p = i ? "width" : "height";
    ...
    function D(e, t, n, o) {
        var i = "BODY" === e.nodeName, f = i ? window : e;
        f.addEventListener(t, n, {passive: !0}), i || D(r(f.parentNode), t, n, o), o.push(f)
    }
    ...
    function K(e, t, n, r) {
        var o = [0, 0], i = -1 !== ["right", "left"].indexOf(r), f = e.split(/(\+|\-)/).map(function (e) {
            return e.trim()
        ...
        return p = p.map(function (e, r) {
            var o = (1 === r ? !i : i) ? "height" : "width", f = !1;
    ...
    }, J = "undefined" != typeof window, Q = ["Edge", "Trident", "Firefox"], Z = 0, $ = 0; $ < Q.length; $ += 1) if (J && 0 <= navigator.userAgent.indexOf(Q[$])) {
        Z = 1;
        break
    }
    var ee, te = J && X(window.MutationObserver), ne = te ? function (e) {
            var t = !1, n = 0, r = document.createElement("span"), o = new MutationObserver(function () {
                e(), t = !1
            });
        ...
        pe = ae.slice(3), ue = {FLIP: "flip", CLOCKWISE: "clockwise", COUNTERCLOCKWISE: "counterclockwise"},
        de = function () {
            function t(n, r) {
        ...
        modifiers: {
            shift: {
                order: 100, enabled: !0, fn: function (e) {
                    ...
                    if (r) {
                        var o = e.offsets, i = o.reference, f = o.popper, s = -1 !== ["bottom", "top"].indexOf(n),
                            a = s ? "left" : "top", p = s ? "width" : "height",
                            u = {start: fe({}, a, i[a]), end: fe({}, a, i[a] + i[p] - f[p])};
                ...
                order: 200, enabled: !0, fn: function (e, t) {
                    var n, r = t.offset, o = e.placement, i = e.offsets, f = i.popper, s = i.reference,
                        a = o.split("-")[0];
                ...
                order: 300, enabled: !0, fn: function (e, t) {
                    ...
                    t.boundaries = r;
                    var i = t.priority, f = e.offsets.popper, s = {
                        primary: function (e) {
                            var n = f[e];
                            return f[e] < r[e] && !t.escapeWithReference && (n = V(f[e], r[e])), fe({}, e, n)
                        }, secondary: function (e) {
                            var n = "right" === e ? "left" : "top", o = f[n];
                ...
                order: 400, enabled: !0, fn: function (e) {
                    var t = e.offsets, n = t.popper, r = t.reference, o = e.placement.split("-")[0], i = G,
                        f = -1 !== ["top", "bottom"].indexOf(o), s = f ? "right" : "bottom", a = f ? "left" : "top",
                        p = f ? "width" : "height";
                ...
                order: 500, enabled: !0, fn: function (e, t) {
                    ...
                    var r = e.placement.split("-")[0], o = e.offsets, i = o.popper, f = o.reference,
                        s = -1 !== ["left", "right"].indexOf(r), a = s ? "height" : "width", p = s ? "top" : "left",
                        u = s ? "left" : "top", d = s ? "bottom" : "right", l = E(n)[a];
                    f[d] - l < i[p] && (e.offsets.popper[p] -= i[p] - (f[d] - l)), f[p] + l > i[d] && (e.offsets.popper[p] += f[p] + l - i[d]);
                    var h = f[p] + f[a] / 2 - l / 2, m = h - c(e.offsets.popper)[p];
                ...
                order: 600, enabled: !0, fn: function (e, t) {
                    ...
                    var n = b(e.instance.popper, e.instance.reference, t.padding, t.boundariesElement),
                        r = e.placement.split("-")[0], o = x(r), i = e.placement.split("-")[1] || "", f = [];
                    switch (t.behavior) {
                        case ue.FLIP:
                            f = [r, o];
                            break;
                    ...
                    return f.forEach(function (s, a) {
                        ...
                        var p = e.offsets.popper, u = e.offsets.reference, d = G,
                            l = "left" === r && d(p.right) > d(u.left) || "right" === r && d(p.left) < d(u.right) || "top" === r && d(p.bottom) > d(u.top) || "bottom" === r && d(p.top) < d(u.bottom),
                            c = d(p.left) < d(n.left), h = d(p.right) > d(n.right), m = d(p.top) < d(n.top),
                ...
                order: 700, enabled: !1, fn: function (e) {
                    var t = e.placement, n = t.split("-")[0], r = e.offsets, o = r.popper, i = r.reference,
                        f = -1 !== ["left", "right"].indexOf(n), s = -1 === ["top", "left"].indexOf(n);
                ...
                order: 850, enabled: !0, fn: function (e, t) {
                    var n = t.x, r = t.y, i = e.offsets.popper, f = T(e.instance.modifiers, function (e) {
                    ...
                    var s, a, p = void 0 === f ? t.gpuAcceleration : f, u = o(e.instance.popper), d = h(u),
                        l = {position: i.position},
                        c = {left: G(i.left), top: G(i.top), bottom: G(i.bottom), right: G(i.right)},
                        m = "bottom" === n ? "top" : "bottom", g = "right" === r ? "left" : "right", v = A("transform");
                    if (a = "bottom" == m ? -d.height + c.bottom : c.top, s = "right" == g ? -d.width + c.right : c.left, p && v) l[v] = "translate3d(" + s + "px, " + a + "px, 0)", l[m] = 0, l[g] = 0, l.willChange = "transform"; else {
                        var b = "bottom" == m ? -1 : 1, w = "right" == g ? -1 : 1;
                ...
                order: 900, enabled: !0, fn: function (e) {
                    ...
                    return t.setAttribute("x-placement", f), I(t, {position: "absolute"}), n
